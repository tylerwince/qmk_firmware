...
#define NumCom LT(_NUMBER, KC_COMMA)
#define SymDot LT(_SYMBOL, KC_DOT)
#define ArwP LT(_ARROW, KC_P)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DVORAK] = LAYOUT_planck_grid(
            /* _DVORAK
             * ,-----------------------------------------------------------------------------------.
             * |   '  |,/Num |./Sym |P/Arw |   Y  |      |      |   F  |   G  |   C  |   R  |   L  |
             * |------+------+------+------+------+-------------+------+------+------+------+------|
             * |A/Ctrl|O/Alt |E/GUI |U/Shft|   I  |      |      |   D  |H/Shft|T/GUI |N/Alt |S/Ctrl|
             * |------+------+------+------+------+------|------+------+------+------+------+------|
             * |   ;  |   Q  |   J  |   K  |   X  |      |      |   B  |   M  |   W  |   V  |   Z  |
             * |------+------+------+------+------+------+------+------+------+------+------+------|
             * | Func |  OLD |      | Esc  | Bksp |     Tab     | Space| Enter|      |      |   /  |
             * `-----------------------------------------------------------------------------------'
             */
          KC_QUOTE,          NumCom,          SymDot,       ArwP,         KC_Y,      KC_NO,  KC_NO, KC_F,     KC_G,         KC_C,         KC_R,         KC_L,
          LCTL_T(KC_A),      LALT_T(KC_O),    LGUI_T(KC_E), LSFT_T(KC_U), KC_I,      KC_NO,  KC_NO, KC_D,     RSFT_T(KC_H), RGUI_T(KC_T), RALT_T(KC_N), RCTL_T(KC_S),
          TD(TD_SEMI_COLON), KC_Q,            KC_J,         KC_K,         KC_X,      KC_NO,  KC_NO, KC_B,     KC_M,         KC_W,         KC_V,         KC_Z,
          OSL(_FUNCTION),    TO(_DVORAK_NEW), KC_NO,        KC_ESCAPE,    KC_BSPACE, KC_TAB, KC_NO, KC_SPACE, KC_ENTER,     KC_NO,        KC_NO,        KC_SLASH
          ),
  ...
  [_DVORAK_OLD] = LAYOUT_planck_grid(
            /* _DVORAK
             * ,-----------------------------------------------------------------------------------.
             * | Tab  |   '  |   ,  |   .  |   P  |   Y  |   F  |   G  |   C  |   R  |   L  |   /  |
             * |------+------+------+------+------+-------------+------+------+------+------+------|
          ...
          TO(_DVORAK),        KC_LCTRL,          KC_LALT,  KC_LGUI, KC_LSFT, KC_SPACE, KC_NO, KC_RGUI, KC_RSFT, KC_RALT, KC_RCTRL, _______
          ),
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    ...
    */
    /*
    // Desert Sun
    [0] = { {14,255,255}, {14,255,255}, {14,255,255}, {33,255,255}, {33,255,255}, {30,96,255}, {30,96,255}, {0,0,255}, {0,0,255}, {141,255,233}, {141,255,233}, {141,255,233},
            {14,255,255}, {14,255,255}, {14,255,255}, {33,255,255}, {33,255,255}, {30,96,255}, {30,96,255}, {0,0,255}, {0,0,255}, {141,255,233}, {141,255,233}, {141,255,233},
            {14,255,255}, {14,255,255}, {14,255,255}, {33,255,255}, {33,255,255}, {30,96,255}, {30,96,255}, {0,0,255}, {0,0,255}, {141,255,233}, {141,255,233}, {141,255,233},
            {14,255,255}, {14,255,255}, {14,255,255}, {33,255,255}, {33,255,255}, {0,0,0}, {0,0,255}, {0,0,255}, {141,255,233}, {141,255,233}, {141,255,233} },
    */

    [0] = { {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255},
            {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255},
            {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255},
            {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255}, {25,255,255} },

    [1] = { {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255},
            {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255},
            {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255},
            {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255}, {33,255,255} },

    [2] = { {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233},
            {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233},
            {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233},
            {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233}, {144,255,233} },

    [3] = { {14,255,255}, {14,255,255}, {14,255,255}, {14,255,255}, {14,255,255}, {14,255,255}, {14,255,255}, {14,255,255}, {14,255,255}, {14,255,255}, {14,255,255}, {14,255,255},
